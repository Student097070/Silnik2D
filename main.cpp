...
int main() {
    ...
    //Wymiary i położenie początkowe przycisku do rozdzielczości
    ...
    float ResolutionButton_y = (HEIGHT / 2.0f) - (ResolutionButton_h / 2.0f); po�o�enie na �rodku*/

    float ResolutionButton_x = 0;// (ResolutionButton_w / 2.0f);
    float ResolutionButton_y = 0;// (ResolutionButton_h / 2.0f); //po�o�enie w lewym g�rnym rogu
    ...
    while (running) {
        ...
        // Zmiana rozmiaru okna
            ...
            // ponowne wy�rodkowanie przycisku
