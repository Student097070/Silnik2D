...
int main() {
    ...
    //Wymiary i polo¿enie pocz¹tkowe przycisku do rozdzielczoœci
    ...
    float ResolutionButton_y = (HEIGHT / 2.0f) - (ResolutionButton_h / 2.0f); po³o¿enie na œrodku*/

    float ResolutionButton_x = 0;// (ResolutionButton_w / 2.0f);
    float ResolutionButton_y = 0;// (ResolutionButton_h / 2.0f); //po³o¿enie w lewym górnym rogu
